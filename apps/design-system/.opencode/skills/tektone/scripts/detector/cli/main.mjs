...
function printUsage() {
  console.log(`Usage: tektone detect [options] [file-or-dir-or-url...]
...
Examples:
  tektone detect src/
  tektone detect index.html
  tektone detect https://example.com
  tektone detect --json .`);
}
            ...
            if (fwConfig) {
              ...
              if (probe.listening && probe.matched) {
                process.stderr.write(
                  ...
                  `  npx tektone detect http://localhost:${fwConfig.port}\n\n`
                );
