 ...
 *
 * .env is loaded from the repo root (copied from tektone-evals). Tests
 ...
 * Override with TEKTONE_SKILL_BEHAVIOR_MODELS=claude-foo,gpt-bar.
 */
export const DEFAULT_MODELS = ['claude-sonnet-4-6', 'gpt-5.5', 'gemini-3.1-flash-lite'];

export function resolveModelList() {
  const override = process.env.TEKTONE_SKILL_BEHAVIOR_MODELS;
