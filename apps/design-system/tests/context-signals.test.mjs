 ...
 * context-aware bare `/tektone` (no-argument) path.
 *
...
let scratch;
beforeEach(() => {
  scratch = fs.mkdtempSync(path.join(os.tmpdir(), 'tektone-signals-'));
});
afterEach(() => {
...
describe('gatherSignals', () => {
  ...
  it('reads the newest critique snapshot score', async () => {
    write('.tektone/critique/2026-05-01T10-00-00Z__home.md',
      '---\nslug: home\nscore: 6\np0: 1\np1: 3\ntimestamp: 2026-05-01T10-00-00Z\n---\nbody\n');
    write('.tektone/critique/2026-05-02T10-00-00Z__home.md',
