...
**WARNING - AI SLOP TRAP**: Review ALL the DON'T guidelines from the parent tektone skill (already loaded in this context) before proceeding. Bold means distinctive, not "more effects."
...
When the result feels right, hand off to `{{command_prefix}}tektone polish` for the final pass.
