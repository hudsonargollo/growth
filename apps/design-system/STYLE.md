...
Editorial brief for tektone.design. Read this before writing or editing user-facing copy: the homepage, sub-pages, command editorials, tutorials, and READMEs.
...
- **Interchangeable copy.** Swap "Tektone" for a competitor name. If nothing becomes false, the copy is generic.
