/**
 * Tektone DevTools Extension - Elements Sidebar Pane
 *
 * Shows Tektone findings for the currently selected element ($0) in the Elements panel.
 */
...
function getPort() {
  if (port) return port;
  port = chrome.runtime.connect({ name: `tektone-sidebar-${tabId}` });
