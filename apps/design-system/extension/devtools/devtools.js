/**
 * Tektone DevTools Extension - DevTools Page
 *
 * Creates the Tektone panel and triggers an auto-scan when DevTools opens.
...
chrome.devtools.panels.elements.createSidebarPane('Tektone', (sidebar) => {
...
const portName = `tektone-devtools-${chrome.devtools.inspectedWindow.tabId}`;
...
function connectLifecycle() {
  ...
  // Default ('panel'): wait until the user opens the Tektone panel or sidebar.
