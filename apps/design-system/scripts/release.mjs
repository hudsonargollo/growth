...
const COMPONENTS = {
  skill: {
    ...
    tweetHeader: (v) => `Tektone v${v} is out.`,
    tweetCta: 'Install / update: npx skills add pbakaus/tektone',
  },
  cli: {
    ...
    tweetHeader: (v) => `Tektone CLI v${v} is out.`,
    tweetCta: 'npm i -g tektone',
  },
  extension: {
    ...
    tweetHeader: (v) => `Tektone browser extension v${v} is out.`,
    tweetCta: null,
  },
};

const REPO_URL = 'https://github.com/pbakaus/tektone';
...
console.log(`\n--- Tweet (${tweet.length}/${TWEET_LIMIT} chars) for @tektone_ai ---`);
console.log(tweet);
