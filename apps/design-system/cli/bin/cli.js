 ...
 *
 * Usage:
 *   npx tektone detect [file-or-dir-or-url...]
 *   npx tektone skills help|install|update
 *   npx tektone --help
 */
...
if (!command || command === '--help' || command === '-h') {
  console.log(`Usage: tektone <command> [options]

Commands:
  detect [file-or-dir-or-url...]   Scan for UI anti-patterns and design quality issues
  skills help                      List all available skills and commands
  skills install                   Install tektone skills into your project
...
Run 'tektone <command> --help' for command-specific options.`);
  process.exit(0);
}
...
if (command === 'detect') {
  ...
  // Default: treat as detect arguments (allow `npx tektone src/` shorthand)
