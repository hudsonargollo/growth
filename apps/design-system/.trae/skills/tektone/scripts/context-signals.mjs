#!/usr/bin/env node
/**
 * Context-signals gatherer for the bare `{{command_prefix}}tektone`
 ...
 * light: no LLM calls, no detector run (`npx tektone detect` is heavier and
 ...
 *   - critique:  the latest cached critique score (.tektone/critique)
