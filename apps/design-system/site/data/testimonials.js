...
export const testimonials = [
  ...
  { id: 'adrien_ninet',    handle: '@adrien_ninet',    name: 'Adrien Ninet',
    ...
    quote: "Uninstall whatever frontend skill you're using. Replace it with Tektone." },
  ...
  { id: 'illscience',      handle: '@illscience',      name: 'Anish Acharya',
    ...
    quote: "Tektone is the most slept on tool for incorporating design thinking into coding workflows." },
  ...
  { id: 'cathrynlavery-1', handle: '@cathrynlavery',   name: 'Cathryn Lavery',
    ...
    quote: "When anyone asks me about design for frontend I always recommend @tektone_ai plugin. I'm very picky with design and it's become part of my everyday stack." },
  ...
  { id: 'carlrannaberg',   handle: '@carlrannaberg',   name: 'Carl Rannaberg',
    ...
    quote: "Tektone is hands down the best UI design skill out there. I use it daily and recommend it to others as well. Great work! 💪" },
  ...
  { id: 'ivanleomk',       handle: '@ivanleomk',       name: 'Ivan Leo',
    ...
    quote: "Tektone is the best skill I've used this year. Can't believe it's free." },
  ...
  { id: 'wanikwai',        handle: '@wanikwai',        name: 'Watson Cyrus Anikwai',
    ...
    quote: "Tektone is so so good. I love it." },
  ...
  { id: 'faizan10114-2',   handle: '@faizan10114',     name: 'Faizan Khan',
    ...
    quote: "I will fight anyone who say anything bad against tektone, just let me know who they are." },
  ...
  { id: 'karatzas_thomas', handle: '@karatzas_thomas', name: 'Thomas Karatzas',
    ...
    quote: "@tektone_ai is really good and is the first time I really felt a 10x productivity boost with AI. And I make an effort to try as many tools as possible." },

  { id: 'faizan10114',     handle: '@faizan10114',     name: 'Faizan Khan',
    avatar: '/assets/testimonials/faizan10114.jpg',
    url: 'https://x.com/faizan10114/status/2052620908615917922',
    quote: "TIL you are the guy behind Tektone. I owe like 3 customer conversions to you. Thank you for such an amazing tool." },
  ...
  { id: 'MikitaHQ',        handle: '@MikitaHQ',        name: 'Mikita',
    ...
    quote: "Shipped a landing page in 2 hours using @conductor_build & @tektone_ai. From idea to prod faster than most people pick a font ;))" },
  ...
  { id: 'IceCreamChai',    handle: '@IceCreamChai',    name: 'Sankalp Mukim',
    ...
    quote: "It's crazy that @tektone_ai is free. It replaces some paid products while being better than them." },
  ...
  { id: 'michaelhedgpeth', handle: '@michaelhedgpeth', name: 'Michael Hedgpeth',
    ...
    quote: "@tektone_ai has been a huge help at all levels from prototyping to production. It has really upped our game. I can't see anything out-of-the-box like this replacing it." },
  ...
  { id: 'littlemartta',    handle: '@littlemartta',    name: 'martta_xu',
    ...
    quote: "Tektone is the best frontend design skill I've used rn. It clears the alternatives by a mile." },
  ...
  { id: 'billzh',          handle: '@billzh',          name: 'billzh',
    ...
    quote: "I'm glad that we never need to touch Figma again. Just run 8 agents using @paper w/ Tektone's Claude skills." },
  ...
  { id: 'johnennis',       handle: '@johnennis',       name: 'John Ennis',
    ...
    quote: "Tektone is such a great skill. I use it multiple times a day every day and it makes a huge difference." },
