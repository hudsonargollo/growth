...
const TIMELINE = [
	...
	{ dt: 560,  action: 'outline-show', caption: 'Selecione qualquer elemento na sua página ao vivo.' },
	{ dt: 300,  action: 'cursor-click' },
	{ dt: 180,  action: 'open-ctx' },
	{ dt: 340,  action: 'cursor-to-cmd' },
	{ dt: 320,  action: 'open-palette', caption: 'Abra a paleta de comandos: o vocabulário de design.' },
	{ dt: 950,  action: 'browse-palette', cmd: 'bolder' },
	{ dt: 700,  action: 'browse-palette', cmd: 'typeset' },
	{ dt: 700,  action: 'browse-target' },
	{ dt: 1000, action: 'pick-target', caption: 'Escolha um verbo de design, ou simplesmente descreva.' },
	{ dt: 560,  action: 'cursor-to-button' },
	{ dt: 250,  action: 'draw-circle', caption: 'Circule o que está fora da marca…' },
	{ dt: 700,  action: 'drop-pin' },
	{ dt: 300,  action: 'type-note', text: 'combine com as suítes abaixo', caption: '…e diga o que você quer.' },
	{ dt: 1800, action: 'hold', caption: 'A marcação e a nota são enviadas ao seu agente.' },
	{ dt: 900,  action: 'cursor-to-go' },
	{ dt: 300,  action: 'click-go', caption: 'Gerando três variações…' },
	{ dt: 1600, action: 'show-variant', n: 1, caption: 'Variação 1 de 3.' },
	{ dt: 1400, action: 'show-variant', n: 2, caption: 'Variação 2 de 3.' },
	{ dt: 1400, action: 'show-variant', n: 3, caption: 'Variação 3 de 3.' },
	{ dt: 900,  action: 'cursor-to-accept' },
	{ dt: 300,  action: 'click-accept', caption: 'Aceito. Gravado no código-fonte.' },
	{ dt: 1800, action: 'reset', caption: 'Selecione qualquer elemento na sua página ao vivo.' },
];
