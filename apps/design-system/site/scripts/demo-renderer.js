...
export function renderCommandDemo(commandId) {
  ...
  if (!demo) {
    // tektone has multiple modes — show a usage guide
    if (commandId === 'tektone') {
      return `
        <div class="demo-container">
          <div class="demo-viewport" style="padding: var(--spacing-lg); font-size: 13px; line-height: 1.6;">
            <div style="display: flex; flex-direction: column; gap: 16px; color: var(--color-ash);">
              <div style="font-size: 14px; color: var(--color-text); font-weight: 600;">Three ways to use /tektone</div>
              <div style="display: flex; flex-direction: column; gap: 14px;">
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  <div style="display: flex; gap: 8px; align-items: baseline;">
                    <code style="font-size: 12px; color: var(--spread-accent, var(--color-accent)); font-weight: 600; white-space: nowrap;">/tektone</code>
                ...
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  <div style="display: flex; gap: 8px; align-items: baseline;">
                    <code style="font-size: 12px; color: var(--spread-accent, var(--color-accent)); font-weight: 600; white-space: nowrap;">/tektone init</code>
                ...
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  <div style="display: flex; gap: 8px; align-items: baseline;">
                    <code style="font-size: 12px; color: var(--spread-accent, var(--color-accent)); font-weight: 600; white-space: nowrap;">/tektone craft</code>
              ...
              <div style="font-size: 12px; opacity: 0.5; margin-top: 2px; font-style: italic;">Start with <code style="font-size: 11px;">/tektone init</code> once per project. Then use the other modes as needed.</div>
            </div>
          </div>
        </div>
      `;
            ...
            <div style="display: flex; flex-direction: column; gap: 16px; color: var(--color-ash);">
              ...
              <div style="display: flex; flex-direction: column; gap: 14px;">
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  ...
                  <span style="opacity: 0.8;">Runs <code style="font-size: 11px;">/tektone shape</code> internally to build a design brief from discovery questions. No code yet.</span>
                </div>
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  <div style="display: flex; gap: 8px; align-items: baseline;">
            ...
            <div style="display: flex; flex-direction: column; gap: 16px; color: var(--color-ash);">
              ...
              <div style="display: flex; flex-direction: column; gap: 14px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 4px;">
                  ...
                  <span style="opacity: 0.8;">The confirmed brief guides <code style="font-size: 11px;">/tektone craft</code> or any other implementation approach. No code written, just the thinking that makes code good.</span>
                </div>
              </div>
              <div style="font-size: 12px; opacity: 0.5; margin-top: 2px; font-style: italic;">Use standalone or as the first step of <code style="font-size: 11px;">/tektone craft</code>.</div>
            </div>
          </div>
        </div>
      `;
